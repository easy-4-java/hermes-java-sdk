...
public class HermesHttpClientConfig {
     ...
     * 拒绝 localhost、环回、私有与保留地址。</p>
     *
     * <p>该校验复用 {@link io.github.easy4j.hermes.util.EndpointGuard}，
     * 与运行期每次出站请求前的二次校验保持一致。</p>
     *
     * @param baseUrl 服务基础 URL
    /**
     * <p>仅供测试代码设置的非安全出口——绕开 {@link EndpointGuard} 的 host 白名单。</p>
     *
     * <p><strong>禁止生产代码调用。</strong>此标志仅用于复现"配置从外部注入未走 setter"
     * 的失败路径测试。生产代码不应触碰此访问器。</p>
     *
