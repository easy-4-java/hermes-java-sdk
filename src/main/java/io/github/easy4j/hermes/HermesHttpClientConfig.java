...
public class HermesHttpClientConfig {
    ...
    /**
     * Selects the explicit endpoint trust policy used by HTTP and SSE.
     *
     * @param endpointPolicy policy to apply
    ...
    /**
     * Revalidates the configured base URL at transport construction time.
     *
